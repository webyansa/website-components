...
const templates: Template[] = [
  ...
  {
    id: "award",
    name: "قالب جائزة الأندية الشبابية",
    description: "صفحة عربية متكاملة لجائزة الأندية الشبابية تشمل التعريف والفئات والمعايير والجوائز والشركاء ومسار التقديم",
    previewPath: "award/index.html",
    folderPath: "award",
    thumbnail: "award/assets/images/jaaz-logo-white.svg",
    features: ["Bootstrap 5 RTL", "جائزة شبابية", "12 قسم", "متجاوب"],
    pages: 1,
    isNew: true,
  },
  {
    id: "shattr",
    name: "قالب شطر — منصة الابتكار الاجتماعي",
    description: "منصة حديثة لعرض التحديات الاجتماعية وتحويل الأفكار والحلول إلى مشاريع قابلة للتطبيق داخل الجمعيات الأهلية",
    previewPath: "shattr/index.html",
    folderPath: "shattr",
    thumbnail: "shattr/challenges/c9.png",
    features: ["تحديات تفاعلية", "صفحات تفاصيل", "دعم RTL", "متجاوب"],
    pages: 3,
    isNew: true,
  },
  {
    id: "raed",
    name: "قالب ممارس — اكتشاف المواهب",
    description: "منصة رقمية متخصصة تساعد الممارسين التربويين على اكتشاف المواهب وتنميتها وتحويل المعرفة إلى أثر ملموس",
    previewPath: "raed/index.html",
    folderPath: "raed",
    thumbnail: "raed/assets/images/raed-loader-icon.svg",
    features: ["Bootstrap 5 RTL", "رحلة تفاعلية", "هوية تعليمية", "متجاوب"],
    pages: 1,
    isNew: true,
  },
];
...
const TemplateCard = ({ template }: { template: Template }) => {
  ...
  const handleDownloadTemplate = async () => {
    ...
    try {
      ...
      const manifestTemplates = ["sanad", "majales", "iskan", "saas", "tansiqiah", "award", "shattr", "raed"];
